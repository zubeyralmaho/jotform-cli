...
func buildLogo() string {
	...
	lines := []string{
		...
		sp(8) + b("▄████▀") + sp(2) + o("▄████▀"),
		sp(6) + b("▄████▀") + sp(2) + o("▄████▀") + sp(2),
		sp(6) + b("▀██▀") + sp(2) + o("▄████▀"),                      // Sarı buradan tamamen çıktı
		sp(10) + o("▄████▀"),                                         // Eski sarı buradaydı, sildik
		sp(10) + o("▀██▀") + sp(2) + y("▄██▄"),                       // Sarı 1 satır aşağı, 1 kare (2 boşluk) sola geldi
		sp(6) + n("▄▄") + sp(6) + y("▄████▀"),                        // n ve y aynı satırda buluştu!
		sp(6) + n("███") + sp(5) + y("▀██▀"),                         // n'nin alt parçasıyla y'nin altı aynı satırda (9 + 5 = 14 hizası)
